      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                if (userDetails.imageBase64 != null)
                  CircleAvatar(
                    radius: 50,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                if (userPreferences.dietaryRestrictions != null)
                ...
                const SizedBox(height: 12),
                if (userPreferences.allergies != null)
                  _buildPreferenceItem(
                ...
                const SizedBox(height: 12),
                if (userPreferences.cuisinePreferences != null)
                  _buildPreferenceItem(
                    icon: Icons.flag,
                ...
                const SizedBox(height: 12),
                if (userPreferences.skillLevel != null)
                  _buildPreferenceItem(
                    icon: Icons.star,
                    title: 'Skill Level',
...
enum PreferenceType { dietary, allergy, cuisine, skill }
...
class UserPreferences {
  ...
  factory UserPreferences.fromJson(Map<String, dynamic> json) {
    return UserPreferences(
      ...
      cuisinePreferences: json['cuisinePreferences'],
...
class ProfilePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Get the current user from your state management solution
    // This example uses Provider, but you can use any state management you prefer
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.pushNamed(
              context,
              '/edit-profile',
              arguments: user, // Pass the user data to edit page
            ),
          ),
        ],
      ),
